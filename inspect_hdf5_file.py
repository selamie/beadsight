            ...
            for i, key in enumerate(f['observations/images'].keys()):
                ...
                if key == 'beadsight':
                    ...
                    #  import pdb; pdb.set_trace()
                     ...
                     grid[(i//3)*image_size[0]:(i//3)*image_size[0]+BEAD_SIZE[0], (i%3)*image_size[1]:(i%3+1)*image_size[1], :] = image_data
...
if __name__ == "__main__":
    filename = "/media/selamg/DATA/beadsight/data/processed_data/episode_1.hdf5"
